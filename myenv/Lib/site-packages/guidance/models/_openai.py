...
try:
    import openai
    openai.api_key = 'ak-tzbnhoSDm7aSS4yQKqExlfEEUiyr1x2ystLDxY49WDB2G29k'
    openai.api_base = "https://api.nextapi.fun"
    client_class: typing.Optional[typing.Type[openai.ChatCompletion]] = openai.ChatCompletion
...
class OpenAIEngine(GrammarlessEngine):
    ...
    def _generator_chat(self, prompt: bytes, temperature: float):
        ...
        try:
            ...
            for part in generator:
                if len(part.choices) > 0:
                    chunk = part.choices[0].delta.get('content', '') or ""
                else:
                    chunk = ""
